      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="mt-0 text-2xl md:text-3xl font-bold leading-tight text-[#0D4EA7] reveal reveal-fade-up" style={{ transitionDelay: "0.15s" }}>
              {t('partners.heading2')}
            </h2>
          </div>
          <Link
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="flex items-center justify-center bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 p-4 h-24 md:h-28 reveal reveal-fade-up"
