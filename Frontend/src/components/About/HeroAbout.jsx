    ...
    <section className="relative w-full min-h-screen bg-[#030712] flex items-center justify-center px-6 pt-20 md:px-10 lg:px-20 overflow-hidden select-none">
      ...
      <div className="max-w-8xl w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-20">
        ...
        <div className="lg:col-span-7 space-y-6 text-left w-full">
          <span className="text-sm font-semibold uppercase tracking-[0.25em] text-blue-500 block reveal reveal-fade-up">
            {t('aboutHero.badge')}
          </span>
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1] reveal reveal-fade-up" style={{ transitionDelay: "0.1s" }}>
          ...
          <div className="space-y-6 text-base sm:text-lg md:text-xl text-slate-400 font-normal leading-relaxed max-w-3xl">
            <p className="reveal reveal-fade-up" style={{ transitionDelay: "0.2s" }}>
              {t('aboutHero.p1')}
            </p>
            <p className="reveal reveal-fade-up" style={{ transitionDelay: "0.3s" }}>
              {t('aboutHero.p2')}
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 w-full aspect-[4/3] sm:aspect-[16/10] md:aspect-[16/10] lg:aspect-[16/9] rounded-3xl overflow-hidden border border-slate-800/60 shadow-2xl relative bg-[#040817] reveal reveal-scale-in" style={{ transitionDelay: "0.15s" }}>
          <img 
            src="/about_hero.jpg"
