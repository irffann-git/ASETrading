      ...
      <div className="max-w-8xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          {MORE_PROJECTS_DATA.map((project, index) => (
            <div
              key={project.id}
              className="group flex flex-col bg-[#051129] border border-white/5 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:border-[#195CCF]/30 hover:-translate-y-1 reveal reveal-fade-up"   // ✨ NEW
        ...
        <div className="mt-10 flex justify-center">
          <Link
            to="/all-projects"
            className="inline-flex items-center justify-center gap-3 px-8 py-3 rounded-lg bg-[#051129] border border-white/10 text-white font-semibold text-sm tracking-wide transition-all duration-300 hover:bg-[#195CCF] hover:border-[#195CCF] group reveal reveal-fade-up"   // ✨ NEW
            style={{ transitionDelay: "0.4s" }}   // ✨ NEW
          >
            VIEW ALL PROJECTS
