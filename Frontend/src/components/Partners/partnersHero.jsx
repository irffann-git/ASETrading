// PartnersHero.jsx – Hero section for the Partners page
...
const PartnersHero = () => {
  ...
  // Scroll‑reveal effect (same as other heroes)
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.15, rootMargin: "0px 0px -30px 0px" }   // <-- FIXED: removed stray "i"
    );
  ...
  return (
    <section className="relative bg-[#020B1D] min-h-[85vh] md:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/partnersHero.png')", // replace with your image path
        }}
      >
      ...
      {/* Scroll Reveal CSS (self‑contained) */}
      <style>{`
        .reveal {
          opacity: 0;
